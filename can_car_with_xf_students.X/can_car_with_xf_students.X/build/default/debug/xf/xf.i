...
# 49 "xf/../mcc_generated_files/mcc.h" 2

# 1 "xf/../mcc_generated_files/device_config.h" 1
# 50 "xf/../mcc_generated_files/mcc.h" 2

# 1 "xf/../mcc_generated_files/pin_manager.h" 1
# 97 "xf/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 109 "xf/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_IOC(void);
# 51 "xf/../mcc_generated_files/mcc.h" 2
...
# 54 "xf/../mcc_generated_files/mcc.h" 2

# 1 "xf/../mcc_generated_files/interrupt_manager.h" 1
# 110 "xf/../mcc_generated_files/interrupt_manager.h"
void INTERRUPT_Initialize (void);
# 55 "xf/../mcc_generated_files/mcc.h" 2

# 1 "xf/../mcc_generated_files/spi2.h" 1
# 59 "xf/../mcc_generated_files/spi2.h"
typedef enum {
    SPI2_DEFAULT
} spi2_modes_t;
...
# 56 "xf/../mcc_generated_files/mcc.h" 2

# 1 "xf/../mcc_generated_files/tmr0.h" 1
# 106 "xf/../mcc_generated_files/tmr0.h"
void TMR0_Initialize(void);
# 135 "xf/../mcc_generated_files/tmr0.h"
void TMR0_StartTimer(void);
# 167 "xf/../mcc_generated_files/tmr0.h"
void TMR0_StopTimer(void);
# 203 "xf/../mcc_generated_files/tmr0.h"
uint16_t TMR0_ReadTimer(void);
# 242 "xf/../mcc_generated_files/tmr0.h"
void TMR0_WriteTimer(uint16_t timerVal);
# 278 "xf/../mcc_generated_files/tmr0.h"
void TMR0_Reload(void);
# 296 "xf/../mcc_generated_files/tmr0.h"
void TMR0_ISR(void);
# 314 "xf/../mcc_generated_files/tmr0.h"
void TMR0_CallBack(void);
# 332 "xf/../mcc_generated_files/tmr0.h"
 void TMR0_SetInterruptHandler(void (* InterruptHandler)(void));
# 350 "xf/../mcc_generated_files/tmr0.h"
extern void (*TMR0_InterruptHandler)(void);
# 368 "xf/../mcc_generated_files/tmr0.h"
void TMR0_DefaultInterruptHandler(void);
# 57 "xf/../mcc_generated_files/mcc.h" 2
# 72 "xf/../mcc_generated_files/mcc.h"
void SYSTEM_Initialize(void);
# 85 "xf/../mcc_generated_files/mcc.h"
...
# 13 "xf/xf.c" 2
# 26 "xf/xf.c"
_Bool XF_pushEvent(Event ev, _Bool inISR, uint8_t* tmid);
...
# 42 "xf/xf.c"
uint8_t XF_scheduleTimer(uint16_t tm, Event ev, _Bool inISR);
...
_Bool XF_pushEvent(Event ev, _Bool inISR, uint8_t* tmid)
{
    ...
    else
    {
        ...
        {
            theXF.maxEvt = theXF.countEvt;
        }
        temp = (theXF.in+1) % (uint8_t)(30);
...
Event XF_popEvent(_Bool inISR)
{
    ...
    theXF.out = (theXF.out + 1)%(uint8_t)(30);
    theXF.countEvt--;
    LEAVECRITICAL(inISR);
    return ev;
}
...
uint8_t XF_post(processEventT processEvent, uint8_t id, uint16_t delay)
{
    ...
    XF_pushEvent(ev,0,&tmid);
    return tmid;
}

void XF_executeOnce()
{
    Event ev = XF_popEvent(0);

    if (ev.processEvent != ((void*)0))
    {
