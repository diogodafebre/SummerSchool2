...
void LCD_Init(void)
{
 ...
 LATDbits.LATD2 = 0;
 TRISJ = 0x0F;
 _delay((unsigned long)((10)*(62500000L/4000.0)));
 LCD_2x16_WriteCmd(0x38);
 _delay((unsigned long)((100)*(62500000L/4000.0)));
 ...
 _delay((unsigned long)((4)*(62500000L/4000.0)));
 LCD_2x16_WriteCmd(0x06);
 _delay((unsigned long)((200)*(62500000L/4000.0)));
  LCD_Clear();
}
...
static void LCD_2x16_WriteCmd(uint8_t command)
{
    ...
    PORTJ = command;
    LATDbits.LATD2 = 1;
    _delay((unsigned long)((4)*(62500000L/4000000.0)));
    LATDbits.LATD2 = 0;
    _delay((unsigned long)((4)*(62500000L/4000000.0)));
    PORTJ = (uint8_t)(command << 4);
    LATDbits.LATD2 = 1;
    _delay((unsigned long)((4)*(62500000L/4000000.0)));
    LATDbits.LATD2 = 0;
    _delay((unsigned long)((80)*(62500000L/4000000.0)));
}
static void LCD_2x16_WriteData(uint8_t command)
{
    ...
    _delay((unsigned long)((4)*(62500000L/4000000.0)));
    LATDbits.LATD2 = 0;
    _delay((unsigned long)((84)*(62500000L/4000000.0)));
}
